...
function deviceTools(){return `<section class="device-tools"><button class="secondary" data-device="install">${icon('external')}Get Steady on your phone</button><p class="sync-caption" role="status">${esc(syncLabel())}</p></section>`;}
